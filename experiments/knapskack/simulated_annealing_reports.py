...
def main():
    ...
    for (init_temp, cooling_rate, min_temp) in configs:
        print(f"Configuracion = init_temp: {init_temp}, cooling_rate: {cooling_rate}, min_temp: {min_temp}")
        total_solutions = 0
        for file_name in file_name_list:
            ...
            solver = Solver(KNAPSACK, SIMULATED_ANNEALING, ACCUM_VALUE,
                            ...
                            algorithm_kwargs={"init_temp": init_temp, "cooling_rate": cooling_rate, "min_temp": min_temp, "time_limit": 90})
            solutions = 0
            times = []
            values = []
            last_it_values = []
